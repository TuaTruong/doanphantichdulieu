                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="gallery-box card">
                                    <div class="gallery-container">
                                        <a class="image-popup"
                                            href="<?php echo e(URL::asset('build/images/small/img-1.jpg')); ?>" title="">
                            ...
                            <div class="swiper-slide">
                                <div class="gallery-box card">
                                    <div class="gallery-container">
                                        <a class="image-popup"
                                            href="<?php echo e(URL::asset('build/images/small/img-2.jpg')); ?>" title="">
                                            <img class="gallery-img img-fluid mx-auto"
                            ...
                            <div class="swiper-slide">
                                <div class="gallery-box card">
                                    <div class="gallery-container">
                                        <a class="image-popup"
                                            href="<?php echo e(URL::asset('build/images/small/img-4.jpg')); ?>" title="">
                                            <img class="gallery-img img-fluid mx-auto"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\tuan\Pictures\SellProxy\interactive\resources\views/advance-ui-swiper.blade.php ENDPATH**/ ?>